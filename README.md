...
| Charge MOSFET reset | `Vmax < 3.45 V` after cutoff | Charge MOSFET ON; approx. 150 mV hysteresis |
...
The physical charge-MOSFET reset criterion is a separate finding from the latest balancing-cycle observation: after cutoff at approximately 3.60 V, permanent recovery is observed below approximately 3.45 V, giving approximately 150 mV of protection hysteresis. The 3.50 V full-detection/CCL threshold remains separate.
