...
required=[root/'README.md',root/'CITATION.cff',root/'site/index.html',root/'site/robots.txt',root/'site/sitemap.xml',root/'report/Dyness_BMS_Balancing_Algorithm_Charge_Control_Firmware_2.50-71.10.11.pdf']
for p in required:
    if not p.exists(): errors.append(f"missing: {p.relative_to(root)}")
html=(root/'site/index.html').read_text(encoding='utf-8')
for term in ['2.50-71.10.11','1.5 A','1.4 A','30 mV','3.5 V','3.6 V','16-cell','cell 16']:
